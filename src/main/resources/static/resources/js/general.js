...
function menu(){
    ...
    html = html +'<ul>'
    html = html +'<li><a href="/classSetup">Class Registration</a></li>';
    html = html +'<li><a href="/studentSearch">Student Search</a></li>';
    html = html +'<li><a href="/addStudentsetup">Student Registration</a></li>';
    html = html +'</ul>';
    html = html +'</li>';
    html = html +'<li id="no-child">';
    html = html +'<a href="/userSearchSetup" style="font-weight:bold;">User Management</a>';
    html = html +'</li>';
    html = html +'</ul>';
    html = html +'</div>';
